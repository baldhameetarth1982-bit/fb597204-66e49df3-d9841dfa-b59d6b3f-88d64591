...
Phase 5 — DONE. Reports page combines payments + ledger + expenses with date filter, monthly bar chart, summary cards (Income/Expense/Net + margin %), CSV export, and print-to-PDF. Drawer entry under Money. Existing Ledger + Expenses pages kept for entry.
